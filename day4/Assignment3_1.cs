...
namespace Day4
{
    ...
    public abstract class Employee:IdbFunctions
    {
        ...
        public Employee(string name = "Akshay", decimal basic = 1000, short deptNo = 10)
        {
